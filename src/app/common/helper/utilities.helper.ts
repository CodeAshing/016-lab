  ...
  async sendEmail(email: string, subject: string, message: string) {
    ...
    const params = {
      Destination: {
        ...
        //  ToAddresses: ["emad.hassan@starmarketingonline.com"] ///Email address/addresses that you want to send your email
      },
      ConfigurationSetName: 'digitalstarmarketing',
      Message: {
        Body: {
          Html: {
      ...
      //Source: "emad.hassan@starmarketingonline.com"
      Source: 'digital@starmarketingonline.com',
    };
